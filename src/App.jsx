            ...
            <h1 className="hero-title-large">
              {currentBrand === 'lifetime' && (
                <>
                  ...
                  <span className="hero-tagline">Trusted Solutions. Lifetime Results.</span>
                </>
              )}
              {currentBrand === 'aih' && brandConfig[currentBrand].tagline}
              {currentBrand === 'closets' && brandConfig[currentBrand].tagline}
            </h1>
            <p className="hero-subtitle-large">
              {currentBrand === 'lifetime' && 'Expert care for the spaces beneath, around, and within your home'}
